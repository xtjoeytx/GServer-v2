Store your weapon scripts in here.  They be in plain text files and be prefixed with -gr_exec_.

As an example, -gr_exec_forcesay.txt:
---------------
...
As an example, we are going to use the -gr_exec_forcesay.txt script to force a player to say, "Hi."
---------------
...
Next, we sent the script off to the targetted player.
