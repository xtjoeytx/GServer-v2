...
#### Clientside only
    ...
    downloadpos                 - (2.14)
    downloadsize                - (2.22)
    focusx                      - sometime before (2.16)
    focusy                      - sometime before (2.16)
    graalversion                - (2.10)
    mousebuttons                - (2.14)
    mousescreenx                - (2.14)
    mousescreeny                - (2.14)
...
#### Clientside only
    ...
    seteffect                   - around (1.20) to (1.33r1)
    seteffect                   - (2.00)
    seteffectmode               - (2.16)
    ...
    setmusicvolume              - (2.00)
    setshape2                   - (2.04)
    setspritesimage             - (5.00r6)
    setstatusimage              - (5.00r6)
    seturllevel                 - (beta 5)
    setzoomeffect               - (2.00)
    ...
    toinventory                 - (beta 5)
    unseteffect                 - around (1.20) to (1.33r1)
...
#### Implemented
    ...
    * getdir(dx, dy)                    - (2.16)
      ...
      getnearestplayer(x, y)            - (5.00r6)
      getnearestplayers(x, y, flag)     - (5.00r6)
      getnpc(name)
      getplayer(account)
