...
{
// --------------------------------------------------------
constexpr size_t builtInCommandCount = 213
#if DEBUG
	+ 1
#endif
	;
...
CMD_REDUCEBOMBS	         : 'reducebombs'          { pushCommand("E"); } -> type(COMMAND);
CMD_REDUCEDARTS	         : 'reducedarts'          { pushCommand("E"); } -> type(COMMAND);
CMD_REDUCERUPEES         : 'reducerupees'         { pushCommand("E"); } -> type(COMMAND);
...
CMD_SETPLAYERX           : 'setplayerx'           { pushCommand("E"); } -> type(COMMAND);
CMD_SETPLAYERY           : 'setplayery'           { pushCommand("E"); } -> type(COMMAND);
...
CMD_SETX                 : 'setx'                 { pushCommand("E"); } -> type(COMMAND);
CMD_SETY                 : 'sety'                 { pushCommand("E"); } -> type(COMMAND);
...
PARAM_L_MC_Q            : MC_Q          { pushCommand("(SS)"); }  -> type(MESSAGECODE);
...
PARAM_M_MC_Q            : MC_Q          { pushCommand("(SS)"); }  -> type(MESSAGECODE);
