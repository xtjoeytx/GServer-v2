...
void bindClass_Environment(CScriptEngine *scriptEngine)
{
	...
	// Properties
	environment_proto->SetAccessor(v8::String::NewFromUtf8(isolate, "global").ToLocalChecked(), Environment_GetObject_Global, nullptr, engine_ref);

	// Method functions
	environment_proto->Set(v8::String::NewFromUtf8(isolate, "reportException").ToLocalChecked(), v8::FunctionTemplate::New(isolate, Environment_ReportException, engine_ref));
	environment_proto->Set(v8::String::NewFromUtf8(isolate, "setCallBack").ToLocalChecked(), v8::FunctionTemplate::New(isolate, Environment_SetCallBack, engine_ref));
	environment_proto->Set(v8::String::NewFromUtf8(isolate, "setNpcEvents").ToLocalChecked(), v8::FunctionTemplate::New(isolate, Environment_SetNpcEvents, engine_ref));
