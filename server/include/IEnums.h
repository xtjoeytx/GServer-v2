...
enum
{
	...
	PLO_HASNPCSERVER			= 44,	// If sent, the client won't update npc props.  Codr note: 5.07 does not handle this.
	PLO_FILEUPTODATE			= 45,
	PLO_HITOBJECTS				= 46,
	PLO_STAFFGUILDS				= 47,
	...
	PLO_BOARDPACKET				= 101,
	PLO_FILE					= 102,
	PLO_UNKNOWN104				= 104,	// Valid message in 5.07.  The code it uses is unique. -Codr
	PLO_UNKNOWN105				= 105,	// Valid message in 5.07.  The code it uses is unique. -Codr
	PLO_UNKNOWN106				= 106,	// Valid message in 5.07.  The code it uses is unique. -Codr
	PLO_UNKNOWN107				= 107,	// Valid message in 5.07.  The code it uses is unique. -Codr
	PLO_NPCBYTECODE				= 131,	// Compiled Torque-script for an NPC. {131}{INT3 id}{code}
	PLO_UNKNOWN132				= 132,	// Valid message in 5.07.  The code it uses is unique. -Codr
	PLO_UNKNOWN133				= 133,	// Valid message in 5.07.  The code it uses is unique. -Codr
	...
	PLO_MOVE					= 165,
	PLO_UNKNOWN166				= 166,	// Valid message in 5.07.  The code it uses is unique. -Codr
	...
	PLO_UNKNOWN169				= 169,	// Valid message in 5.07.  It's strange... the parameter seems to be a direct pointer value which would be difficult for the server to know about unless the client actually sends that information.  I don't know what purpose that could serve, however. -Codr
	PLO_GHOSTMODE				= 170,
	PLO_BIGMAP					= 171,
	...
	PLO_RPGWINDOW				= 179,
	PLO_STATUSLIST				= 180,
	PLO_UNKNOWN181				= 181,	// Valid message in 5.07.  The code it uses is unique. -Codr
	PLO_LISTPROCESSES			= 182,
	PLO_UNKNOWN183				= 183,	// Valid message in 5.07.  The code it uses is unique. -Codr
	PLO_UNKNOWN184				= 184,	// Valid message in 5.07.  The code it uses is unique.  The string "screenshots" is present in the code.  I didn't look in detail. -Codr
	PLO_UNKNOWN185				= 185,	// Valid message in 5.07.  The code it uses is unique. -Codr
	PLO_UNKNOWN186				= 186,	// Valid message in 5.07.  The code it uses is unique. -Codr
	PLO_UNKNOWN187				= 187,	// Valid message in 5.07.  The code it uses is unique. -Codr
	...
	PLO_UNKNOWN191				= 191,	// Valid message in 5.07.  The code it uses is unique. -Codr
	PLO_NC_WEAPONGET			= 192,	// {192}{CHAR name length}{name}{CHAR image length}{image}{script}  Codr note: Unhandled by 5.07.
	PLO_UNKNOWN193				= 193,	// Valid message in 5.07.  The code it uses is unique.  The first parameter is likely a 5-byte integer.  There may be more. -Codr
