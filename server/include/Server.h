...
public:
	...
	void sendPacketToLevelArea(const PlayerOutPacket& packet, std::weak_ptr<Level> level, const std::set<uint16_t>& exclude = {}, PlayerPredicate sendIf = nullptr) const;
	void sendPacketToLevelArea(const PlayerOutPacket& packet, std::weak_ptr<Player> player, const std::set<uint16_t>& exclude = {}, PlayerPredicate sendIf = nullptr) const;
	void sendPacketToOneLevel(const PlayerOutPacket& packet, std::weak_ptr<Level> level, const std::set<uint16_t>& exclude = {}) const;
