...
constexpr std::array<std::string_view, 33> AdminServerOptions = {
	"name", "description", "url", "serverip", "serverport", "serverinterface",
	"localip", "upnp", "listip", "listport", "maxplayers", "onlystaff",
	"nofoldersconfig", "serverside", "sharefolder", "language", "protectdbnpcs",
	// GR extensions
	...
	"flaghack_movement", "flaghack_ip", "generation", "servermode", "runallscriptevents", "clientsidesigns", "clientsidelinks", "localhost",
};
